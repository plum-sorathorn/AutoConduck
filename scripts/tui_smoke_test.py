...
def main() -> int:
    try:
        ...
        from autoconduck.tui.tune import TuneScreen
        for name, value in (("MainMenuScreen", MainMenuScreen), ("DashboardScreen", DashboardScreen), ("ModelCatalogScreen", ModelCatalogScreen), ("TuneScreen", TuneScreen)):
            value()
